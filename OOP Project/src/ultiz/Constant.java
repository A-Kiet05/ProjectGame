...
public class Constant {
    ...
    public static class Projectiles{
        ...
        public static final int CANNON_BALL_WIDTH = (int) (CANNON_BALL_WIDTH_DEFAULT * GAME_SCALE);
        public static final int  CANNON_BALL_HEIGHT= (int) (CANNON_BALL_HEIGHT_DEFAULT * GAME_SCALE);


        public static final float CANNON_SPEED = 0.5f * GAME_SCALE;
    }
